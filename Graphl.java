...
//Edge it = (Edge) vertex[v].getValue();
//return it.vertex();
//}
...
//vertex[i].next())
//if (((Edge) vertex[i].getValue()).vertex() > j) break;
//vertex[i].insert(currEdge);
//}
//}
///** Delete an edge */
...
//if (((Edge) vertex[v].getValue()).vertex() == w) return true;
//return false;
//}
///** @return an edge’s weight */
//public int weight(int i, int j) {
//if (isEdge(i, j)) return ((Edge) vertex[i].getValue()).weight();
//return 0;
//}
